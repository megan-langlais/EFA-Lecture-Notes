...
//loop structure: a) creation of an indexing variable b) run condition c)change to the indexing variable
...
//loops can run infinitely. don't run this code!! This will break your code and is considered a bug. 
// for(let i = 0; ; i++){
//  console.log(i);
// }
