...
//equality comparison operator, type coersion, compares value
console.log('3' == 3);
console.log(4 == 4);
console.log(3 == '4');

//strict equality comparison operator, compares value and type
console.log(3 === 3);
console.log('3'=== 3);

//not equal comparison operator
console.log('3' != 4);
console.log('3' != 3); //not equal only compares value, not type.

//strict not equal comparison operator
console.log('3' !== 3);
console.log(3 !== 3); //strict not equal compares value and type
